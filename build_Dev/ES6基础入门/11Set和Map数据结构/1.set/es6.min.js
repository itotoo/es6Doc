...
(function () {
    var arr = [3, 5, 2, 2, 5, 5];
    console.log([].concat(_toConsumableArray(new Set(arr))));
})();
(function () {
    // map
    var arr = [3, 5, 2, 2, 5, 5];
    console.log(arr = [].concat(_toConsumableArray(new Set(arr))).map(function (x) {
        return x + '0000';
    }));
    console.log('map', arr);
})();
(function () {
    // filter
    var arr = [3, 5, 2, 2, 5, 5];
    console.log([].concat(_toConsumableArray(new Set(arr))).filter(function (x) {
        return x % 2 !== 0;
    }));
})();
...
(function () {
    ...
    var b = new Set([4, 3, 2]);
    // 并集
    console.log('并集', new Set([].concat(_toConsumableArray(a), _toConsumableArray(b))));
    // 交集
    console.log('交集', new Set([].concat(_toConsumableArray(a)).filter(function (x) {
        return b.has(x);
    })));
    // 差集
    console.log('差集', new Set([].concat(_toConsumableArray(a)).filter(function (x) {
        return !b.has(x);
    })));
})();
